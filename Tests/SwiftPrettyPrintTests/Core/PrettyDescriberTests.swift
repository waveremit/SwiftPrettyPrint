    ...
    func testString_Struct() {
        ...
        assert(to: describer.string) {
            args(
                dog,
                false,
                expect: #"Dog(name: "Pochi", owner: Owner(name: "Nanachi", age: 20, address: "4th layer in Abyss"), age: nil)"#
            )
            args(
                dog,
                true,
                expect: #"Dog(name: "Pochi", owner: Owner(name: "Nanachi", age: 20, address: Optional("4th layer in Abyss")), age: nil)"#
            )
        }
    }
    ...
    func testString_Dictionary() {
        ...
        assert(to: describer.string) {
            args(
                dictionaryInStruct,
                false,
                expect: #"["mike": Cat(id: "mike", name: "ポチ"), "tama": Cat(id: "tama", name: "タマ")]"#
            )
            args(
                dictionaryInStruct,
                true,
                expect: #"["mike": Cat(id: "mike", name: Optional("ポチ")), "tama": Cat(id: "tama", name: Optional("タマ"))]"#
            )
        }
    }
    ...
    func testString_Tuple() {
        ...
        assert(to: describer.string) {
            args(
                labeledTuple,
                false,
                expect: #"(2019, region: "Chili", variety: "Chardonnay", taste: ["round", "smooth", "young"])"#
            )
            args(
                labeledTuple,
                true,
                expect: #"(2019, region: "Chili", variety: Optional("Chardonnay"), taste: ["round", "smooth", "young"])"#
            )
        }
    }
